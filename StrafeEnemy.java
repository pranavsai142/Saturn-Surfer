...
public class StrafeEnemy implements Sprite {
	
	String ENEMY_IMAGE = "assets/DPRKmissle.png";
	...
	public StrafeEnemy(int x, int y, int h) {
	...
	public boolean isMoving() {
		...
		return movingLeft || movingRight || movingBackward;
	}
	...
	public void shoot() {
		regEnemyProjectiles.add(new RegEnemyProjectile((int) currentPosition.getX() + 190, (int) currentPosition.getY() - 65, game.getStrafeHeight()));
	}
}